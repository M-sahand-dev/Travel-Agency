...
export const Banner = (): JSX.Element => {
  return (
    <div className="my-14 ">
      <div className="container rounded-5xl text-white  relative mx-auto lg:bg-[url(/image/baner/light.png)] bg-no-repeat bg-cover  bg-center   lg:dark:bg-[url(/image/baner/dark.png)] dark:border dark:border-white-quinary max-lg:bg-blue-primary max-lg:dark:bg-dark-quinary">
        <div className="m-auto py-8 px-96 text-center flex flex-col items-center justify-center gap-10 max-lg:hidden ">
          ...
          <div className="flex flex-wrap gap-6 justify-center  ">
            <button className="flex items-center gap-1 bg-white text-dark-primary p-4 rounded-5xl">
              <span>دریافت از </span>
              <img src={"/image/baner/بازار.png"} alt="" />
            ...
            <button className="flex items-center gap-1 bg-white text-dark-primary p-4 rounded-5xl">
              <span>دریافت از </span>
              <img src={"/image/baner/مایکت.png"} alt="" />
              <svg className=" w-10 h-10">
                <use href="#myket"></use>
              </svg>
            </button>
